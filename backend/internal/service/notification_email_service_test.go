...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "Habifying", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "Habifying", "https://example.com/reset", "en-US"))
...
func (s *notificationEmailTestSMTPServer) settings() map[string]string {
	...
	return map[string]string{
		...
		SettingKeySMTPFromName: "Habifying",
